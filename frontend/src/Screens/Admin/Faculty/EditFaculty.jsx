...
const EditFaculty = () => {
  ...
  const updateFacultyProfile = (e) => {
    ...
    formData.append("jntuId", data.jntuId);
    formData.append("aicteId", data.aicteId);
    if (file) {
      ...
      .then((response) => {
        ...
        if (response.data.user.length === 0) {
          ...
          setData({
            ...
            panCard: response.data.user[0].panCard,
            jntuId: response.data.user[0].jntuId,
            aicteId: response.data.user[0].aicteId,
          });
        }
      })
      .catch((error) => {
    ...
    <div className="my-6 mx-auto w-full">
      ...
      {search && id && (
        ...
        >
          ...
          <div className="w-[40%]">
            <label htmlFor="panCard" className="leading-7 text-sm ">
              PAN CARD
            </label>
            <input
              type="text"
          ...
          <div className="w-[40%]">
            <label htmlFor="jntuId" className="leading-7 text-sm ">
              JNTU ID
            </label>
            <input
              type="text"
          ...
          <div className="w-[40%]">
            <label htmlFor="aicteId" className="leading-7 text-sm ">
              AICTE ID
            </label>
            <input
              type="text"
