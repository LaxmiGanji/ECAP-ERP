...
Try typing a question below or click one of the quick suggestions!`,
  ...
  return (
    <div className="w-full space-y-6">
      ...
      <div className="bento-header-banner flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center space-x-3.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] px-2.5 py-0.5 rounded-full bg-cyan-50 text-cyan-700 font-bold border border-cyan-100 flex items-center gap-1">
                <FiDatabase className="w-3 h-3 text-cyan-600" /> Pinecone Vector DB (RAG)
              </span>
            </div>
        ...
        <div className="flex items-center gap-3">
          <select
            ...
            className="bg-slate-50 border border-slate-200 text-xs font-semibold text-slate-900 rounded-xl px-3 py-2 focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all outline-none"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 text-xs bg-indigo-50 hover:bg-indigo-100 border border-indigo-100 text-indigo-700 font-bold px-3.5 py-2 rounded-xl transition-all shadow-sm"
          >
            <FiRefreshCw className="w-3.5 h-3.5 text-indigo-600" /> Sync Vectors
          </button>
        </div>
      </div>
      ...
      <div className="bg-slate-900 border border-slate-800 text-slate-100 rounded-2xl overflow-hidden shadow-xl min-h-[580px] flex flex-col">
